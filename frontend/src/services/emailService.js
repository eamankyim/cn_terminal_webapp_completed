...
class EmailService {
  constructor() {
    ...
    this.apiKey = emailConfig.sendGridApiKey || sendgridConfig.apiKey;
    this.fromEmail = emailConfig.fromEmail || sendgridConfig.fromEmail;
    this.fromName = emailConfig.fromName || sendgridConfig.fromName;
    this.devMode = emailConfig.devMode || sendgridConfig.devMode;
